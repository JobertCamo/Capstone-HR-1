<div class="w-full h-full bg-cover text-slate-50 headsearch">
        ...
        <div class=" w-[90%] h-[80%] flex items-center justify-center flex-col">
            ...
            <div class="h-[80%] w-[95%] flex-row flex p-2 bg-[#060606] bg-opacity-[80%] rounded-2xl">
                <div class="flex-1 p-5 overflow-auto ">
                    <h1 class="mb-3 text-xl font-bold">Job Summary</h1>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iste mollitia fuga neque magnam, et at provident perspiciatis recusandae praesentium voluptatum reiciendis natus a consequuntur dolorem tempora illum quo dolores cumque!</p>
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Iste mollitia fuga neque magnam, et at provident perspiciatis recusandae praesentium voluptatum reiciendis natus a consequuntur dolorem tempora illum quo dolores cumque!</p>
                </div>
                <div class="flex-1 p-5 overflow-auto ">
